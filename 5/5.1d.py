...
model = input('Введите имя устройства: ')
temp = ','.join(list(london_co[model].keys()))
model2 = input('Введите имя параметра ('+temp+'): ').lower()
a = london_co[model]
print(a.get(model2,'Такого параметра нет'))